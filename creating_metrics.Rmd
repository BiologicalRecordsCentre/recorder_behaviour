...
iRB$kmsq <- reformat_gr(raw_kmsq[1,], prec_out = 1000)
...
# Let's try a big correlation matrix
cor_data <- cor.matrix(variables = all_metrics[,!colnames(all_metrics) %in% 'recorder'])
ggcorplot(cor.mat = cor_data,
          data = all_metrics,
          var_text_size = 5,
          cor_text_limits = c(5,10))
